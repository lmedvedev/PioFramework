...
namespace BOF
{
    public class TreeController<TS, TD> 
        ...
        where TD : BaseDat<TD>, ITreeDat, new()
    {
        ...
        private CtlTree _TreeV = new CtlTree();
        public CtlTree TreeV
        {
            get { return _TreeV; }
            //set { _TreeV = value; }
        }

        private CardTreeForm _EntityForm = null;
        public CardTreeForm EntityForm
        {
        ...
        void ValueDelete(object sender, EventArgs e)
        {
            ...
            else
            {
                try
                {
                    ...
                    {
                        dat.Delete();
                        Reload((dat.Parent_FP == null) ? "" : dat.Parent_FP.ToString());
                    }
                }
                catch (Exception Ex)
                {
